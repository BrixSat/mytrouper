...
;(function( $ ) {
	...
	function dateSlider(show, flags, eventsOpts) {
		var $eventsCalendarSlider = $("<div class='eventCalendar-slider'></div>"),
			...
			$eventsCalendarDaysList = $("<ul class='eventCalendar-daysList hidden-xs'></ul>"),
			date = new Date();
	...
	function getEventsData(flags, eventsOpts, data, limit, year, month, day, direction){
		...
		flags.wrap.find('.eventCalendar-list').animate({
			...
			if (!events.length) {
				...
				$('.calendar-horizontal .eventCalendar-list-wrap').fadeOut(function(){
					$('.calendar-horizontal .eventCalendar-list-wrap + blockquote').fadeIn();
				});

			}else{

				$('.calendar-horizontal .eventCalendar-list-wrap + blockquote').fadeOut(function(){
					$('.calendar-horizontal .eventCalendar-list-wrap').fadeIn();
				});
			}
