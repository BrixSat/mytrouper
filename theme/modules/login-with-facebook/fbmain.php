...
require_once '../../../includes/config.php';
	    require_once SITE_FILE.'includes/inc.php';
	    $fun = new functions($pdet['url_link_id']);
 ...
 */
    ...
    $fbconfig['baseurl']    = SITE_PATH."theme/modules/login-with-facebook/fbmain.php"; //"http://thinkdiff.net/demo/newfbconnect1/php/sdk3/index.php";
